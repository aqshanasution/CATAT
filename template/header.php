...
<nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link putih" href="dashboard.php"><i class="fa fa-desktop mr-2"></i>Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link putih" href="index.php"><i class="fa fa-book mr-2"></i>Kasir</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="dashboard.php"><i class="fa fa-desktop text-purple mr-2"></i>Dashboard</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="index.php"><i class="fa fa-book text-purple mr-2"></i>Kasir</a>
                    </li>
                    <li class="nav-item">
